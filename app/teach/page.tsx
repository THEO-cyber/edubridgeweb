      ...
      <div className="container-x max-w-2xl py-14">
        ...
        {!loading && !user && (
          <Panel>
            ...
            <p className="mt-2 text-muted">Apply in one step — no account needed up front. We create your instructor account only once you&apos;re approved. Already have an account? Log in and apply from there.</p>
            <div className="mt-6 flex gap-3">
              <Link href="/teach/register" className="rounded-xl bg-navy px-6 py-3 font-semibold text-white hover:bg-brand-700">Apply to teach</Link>
